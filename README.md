...
The task was to create a PowerPoint presentation wihch outlines the approach we will be taking to identify which of the __1000 customers__ *Sprocket Central Pty Ltd* should target, based on [this](https://github.com/drmonikabalint/KPMG-virtual-internship/blob/master/KPMG_VI_New_raw_data_update_final.xlsx) dataset.
